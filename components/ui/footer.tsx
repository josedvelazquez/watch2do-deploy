            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-1">
                        <Link href="/" className="flex items-center gap-2 text-xl font-bold text-black dark:text-white mb-6">
                    ...
                    {/* Products Column */}
                    <div>
                        <h4 className="text-black dark:text-white font-bold mb-6">Productos</h4>
                    ...
                    {/* Support Column */}
                    <div>
                        <h4 className="text-black dark:text-white font-bold mb-6">Soporte</h4>
                        <ul className="space-y-4 text-sm text-[#9CA3AF]">
