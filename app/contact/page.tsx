        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-1 container mx-auto px-4 py-12">
                ...
                <div className="text-center mb-16 space-y-4">
                    <h1 className="text-4xl md:text-5xl font-bold text-white font-serif">Contáctanos</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        <Card className="h-full bg-zinc-900/50 border-white/10">
                            <CardContent className="p-8">
                                <h2 className="text-2xl font-bold text-white mb-8 font-serif">Envíanos un mensaje</h2>
                                <form className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            id="message"
                                            rows={5}
                                            className="w-full bg-white/5 border border-white/10 rounded-md px-4 py-3 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all resize-none"
                                            placeholder="Cuéntanos cómo podemos ayudarte..."
                                        />
                                    </div>

                                    <Button className="w-full text-lg py-6 bg-[#D4AF37] hover:bg-[#B5952F] text-black font-bold">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="bg-zinc-900/50 border-white/10">
                            <CardContent className="p-6 flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-white mb-2 font-serif">Nuestra oficina</h3>
                        ...
                        <Card className="bg-zinc-900/50 border-white/10">
                            <CardContent className="p-6 flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-white mb-2 font-serif">Teléfono</h3>
                                    <p className="text-gray-400 text-sm mb-1">+52 55 1234 5678 Lunes a</p>
                                    <p className="text-gray-400 text-sm mb-1">Viernes: 9:00 - 18:00</p>
                        ...
                        <Card className="bg-zinc-900/50 border-white/10">
                            <CardContent className="p-6 flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-white mb-2 font-serif">Email</h3>
                                    <p className="text-gray-400 text-sm hover:text-primary transition-colors cursor-pointer">info@watch2do.com</p>
                                    <p className="text-gray-400 text-sm hover:text-primary transition-colors cursor-pointer">soporte@watch2do.com</p>
                                    <p className="text-gray-400 text-sm hover:text-primary transition-colors cursor-pointer">ventas@watch2do.com</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-zinc-900/50 border-white/10">
                            <CardContent className="p-6">
                                <h3 className="text-lg font-bold text-white mb-4 font-serif">Síguenos en redes sociales</h3>
